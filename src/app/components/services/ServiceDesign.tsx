      ...
      <div className="mt-5 space-y-8">
        {visibleServices.map((service, index) => (
          <div key={service.id} className="md:w-[1110px] md:h-[540px] h-[940px]">
            <div
              className={`h-[540px] grid md:justify-center items-center md:grid-cols-2 ${
                index % 2 === 1 ? 'md:flex-row-reverse' : ''
              }`}
            >
              <div
                className={`h-[508px] max-w-[523px] ${index % 2 === 1 ? 'order-1 md:order-2' : ''}`}
              >
                <ExternalImage
              ...
              <div
                className={`h-[413px] mt-5 flex flex-col justify-evenly md:justify-between ${
